...
def get_ner_metrics(true_lbs,
    ...
    Metrics
    """
    p = metrics.precision_score(true_lbs, pred_lbs, mode=mode, scheme=scheme)
    r = metrics.recall_score(true_lbs, pred_lbs, mode=mode, scheme=scheme)
    f = metrics.f1_score(true_lbs, pred_lbs, mode=mode, scheme=scheme)
    return Metric(p, r, f)
